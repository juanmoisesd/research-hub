...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). Research Hub: Open datasets, dashboards and research by Juan Moisés de la Serna Tuya (UNIR). 500+ DOIs. GitHub. https://github.com/juanmoisesd/research-hub
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "Research Hub: Open datasets, dashboards and research by Juan Moisés de la Serna Tuya (UNIR). 500+ DOIs." GitHub. https://github.com/juanmoisesd/research-hub.
```
...
@misc{delaserna2026_researchhub,
  ...
  title        = {Research Hub: Open datasets, dashboards and research by Juan Moisés de la Serna Tuya (UNIR). 500+ DOIs},
  year         = {2026},
...
TI  - Research Hub: Open datasets, dashboards and research by Juan Moisés de la Serna Tuya (UNIR). 500+ DOIs
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/research-hub
...
### Vancouver / IEEE
```
de la Serna Tuya JM. Research Hub: Open datasets, dashboards and research by Juan Moisés de la Serna Tuya (UNIR). 500+ DOIs. GitHub; 2026. Available: https://github.com/juanmoisesd/research-hub. ORCID: 0000-0002-8401-8018.
```
