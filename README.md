# Research Hub — Juan Moisés de la Serna Tuya
...
[![Pages](https://img.shields.io/badge/Live-Dashboard-brightgreen)](https://juanmoisesd.github.io/research-hub/)


## Overview

Central hub: Open datasets and research by Juan Moisés de la Serna Tuya (UNIR). 92+ DOIs.

## 🌐 Live Dashboard

**[Open Interactive Dashboard](https://juanmoisesd.github.io/research-hub/)**
...
> de la Serna Tuya, J.M. (2026). *Research Hub — Juan Moisés de la Serna Tuya*. GitHub. https://github.com/juanmoisesd/research-hub
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Central hub: Open datasets, dashboards and research by Juan Moisés de la Serna Tuya (UNIR). 92+ DOIs across Harvard Dataverse, Zenodo, Mendeley, Figshare.* [Dataset]. GitHub. https://github.com/juanmoisesd/research-hub

**BibTeX**
```bibtex
@dataset{delaserna2025_research_hub,
